...
class QuakeListPage extends React.Component {
  constructor() {
    super();
    this.state = {
      quakes: [],
...
const connectedQuakeList = connect(mapState, actionCreators)(QuakeListPage);
export { connectedQuakeList as QuakeListPage };
